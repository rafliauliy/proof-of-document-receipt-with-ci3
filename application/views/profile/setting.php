    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_perusahaan', $user['nama_perusahaan']); ?>" name="nama_perusahaan" id="nama_perusahaan" type="text" class="form-control" placeholder="Nama Perusahaan Anda...">
                        </div>
                        <?= form_error('nama_perusahaan', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama">Nama PIC</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-user"></i></span>
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="alamat">Alamat Perusahaan</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="no_wa">Nomor Whatsapp PIC</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fab fa-whatsapp"></i></span>
                            </div>
                            <input value="<?= set_value('no_wa', $user['no_wa']); ?>" name="no_wa" id="no_wa" type="text" class="form-control" placeholder="Nomor Whatsapp PIC...">
                        </div>
